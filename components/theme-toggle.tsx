    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="btn-glass hover:bg-white/10 transition-all duration-300 hover:scale-110"
        >
      ...
      <DropdownMenuContent align="end" className="glass-card border-white/20 backdrop-blur-xl">
